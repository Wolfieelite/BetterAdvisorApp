...
function RouteComponent() {
  ...
  const loginFormSchema = z.object({
    username: z
      .string()
      .min(3, 'Username needs to be longer than 3 characters'),
    password: z
      .string()
      .min(5, 'Password needs to be greater than 5 charcters'),
  })
  ...
  const onSubmit = async (data: z.infer<typeof loginFormSchema>) => {
    ...
    if (result.state == 'FAILED') {
      // TODO: show error toast / message (probably from shadcn)
      ...
      <section className="h-full flex flex-col gap-4 justify-center align-middle lg:grid lg:grid-cols-2 m-auto">
        ...
        >
          ...
          <FieldGroup className="px-8">
            <FormElement<z.infer<typeof loginFormSchema>>
              form={form}
              inputType="email"
              name="username"
              htmlForId="username"
